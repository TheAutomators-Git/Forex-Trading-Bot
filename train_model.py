...
from environments import ScalpTradingEnv, RewardAndProfitCallback
...
csv_env = DummyVecEnv([lambda: ScalpTradingEnv(df, window_size=5)])
model = A2C('MlpPolicy', csv_env, verbose=1)
